...
export class NotifySchedule {
  scheduleJob(bot: TelegramBot): schedule.Job[] {
    const sundayBuyJob = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 0 }, () => this.sendSundayBuy(bot));
    const sundayRecordJob = schedule.scheduleJob({ hour: 14, minute: 0, dayOfWeek: 0 }, () => this.sendSundayRecord(bot));
    const mon1Job = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 1 }, () => this.sendTurnipPrice(bot));
    const mon2Job = schedule.scheduleJob({ hour: 14, minute: 0, dayOfWeek: 1 }, () => this.sendTurnipPrice(bot));
    const tue1Job = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 2 }, () => this.sendTurnipPrice(bot));
    const tue2Job = schedule.scheduleJob({ hour: 14, minute: 0, dayOfWeek: 2 }, () => this.sendTurnipPrice(bot));
    const wed1Job = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 3 }, () => this.sendTurnipPrice(bot));
    const wed2Job = schedule.scheduleJob({ hour: 14, minute: 0, dayOfWeek: 3 }, () => this.sendTurnipPrice(bot));
    const thu1Job = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 4 }, () => this.sendTurnipPrice(bot));
    const thu2Job = schedule.scheduleJob({ hour: 14, minute: 0, dayOfWeek: 4 }, () => this.sendTurnipPrice(bot));
    const fri1Job = schedule.scheduleJob({ hour: 10, minute: 0, dayOfWeek: 5 }, () => this.sendTurnipPrice(bot));
